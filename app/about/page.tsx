            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                ...
                <div className="space-y-6 text-white/90 text-lg md:text-xl">
                  <p>
                    Бид санхүүгийн зах зээлд шинэлэг шийдэл санал болгож,
                    хөрөнгө оруулагчдад уян хатан, найдвартай санхүүгийн
                    хэрэгсэл санал болгож байна.
                  </p>

                  <p>
                    Манай платформ нь хөрөнгө оруулагчдад богино хугацаанд өндөр
                    өгөөжтэй бондод хөрөнгө оруулах боломжийг олгож, санхүүгийн
                    зах зээлийг илүү хүртээмжтэй болгох зорилготой.
                  </p>

                  <p>
                    Бид технологийн шийдэл, санхүүгийн мэргэжлийн багаас бүрдсэн
                    багтайгаа хамт таны санхүүгийн зорилгод хүрэхэд туслахад
                    бэлэн байна.
                  </p>
                </div>
                ...
                <div className="mt-12">
                  <Link href="/">
                    <Button className="bg-white text-[#1782e0] hover:bg-white/90 px-8 py-6 text-lg font-semibold rounded-full shadow-sm transition-colors flex items-center gap-2">
